    ...
    <div className="max-w-7xl mx-auto px-4 py-6 page-enter">
      ...
      <div className="relative overflow-hidden rounded-2xl mb-8">
        ...
        <div className="relative px-6 md:px-10 py-10 text-white">
          ...
          {/* Search Bar in Hero */}
          <form onSubmit={handleSearch} data-tour="hero-search" className="flex gap-2 max-w-xl mb-6">
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white px-6 py-3 rounded-xl text-sm font-bold transition-all shadow-lg hover:shadow-pink-500/40 border border-pink-400/20 whitespace-nowrap"
            >
              Search
            </button>
          </form>
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-5 sm:grid-cols-5 lg:grid-cols-10 gap-2.5" data-tour="categories">
          {categories.map(cat => (
            <Link
              key={cat}
