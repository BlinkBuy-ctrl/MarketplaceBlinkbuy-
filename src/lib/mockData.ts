...
export const CATEGORIES = [
  "All Categories","Electronics","Clothing","Food","Furniture",
  "Tools","Vehicles","Farm Produce","Books","Phones","Other",
];
...
// Placeholder image URLs using a reliable free service
...
export const MOCK_ITEMS: MarketplaceItem[] = [
  ...
  {
    id: "7",
    title: "Electric Drill + Bits Set",
    description: "Bosch electric drill, 750W. Comes with a full bit set (45 pieces). Works perfectly. Used on two renovation projects. Perfect for home use.",
    category: "Tools",
    price: 65000,
    location: "Mzuzu",
    condition: "Good",
  ...
  {
    id: "9",
    title: "Tecno Spark 10 Pro — Sealed",
  ...
  },
  {
    ...
    description: "2-burner gas cooker in excellent condition. Both burners work perfectly. Auto-ignition. Selling as kitchen being renovated and upgrading to built-in hob.",
    category: "Other",
    price: 55000,
    location: "Blantyre",
    condition: "Good",
  ...
  },
  {
    ...
    description: "Fresh tomatoes from Salima. Ready for delivery. Minimum order 20kg. Great for restaurants, vendors and households. Very sweet variety.",
    category: "Food",
    price: 28000,
    location: "Salima",
    condition: "New",
    images: [IMG("tomatoes1")],
    is_featured: false,
  ...
  },
  {
    ...
    description: "Full sofa set. 3-seater, 2-seater and 1-seater. Brown faux leather. Good condition with minor wear. Moving house, need to sell quickly. Collection only.",
    category: "Furniture",
    price: 320000,
    location: "Zomba",
    condition: "Fair",
  ...
  },
  {
    ...
    description: "Canon EOS 200D DSLR. 24MP. Comes with 18-55mm kit lens, 50mm f/1.8 prime, 2x batteries, bag, SD card. Used professionally for 2 years. Excellent photos.",
    category: "Electronics",
    price: 680000,
    location: "Blantyre",
    condition: "Good",
